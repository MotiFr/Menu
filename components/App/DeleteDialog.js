...
export default function DeleteDialog({ setRefresh, item, isOpen, onClose }) {
    ...
    return <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-[26rem]">
            ...
            <p className="text-lg font-semibold text-gray-900 dark:text-white">Are you sure you want to delete 
                <span className="font-extrabold"> {item.name} </span> ?</p>
